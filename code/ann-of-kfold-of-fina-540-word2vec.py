...
from keras.layers import Dense, Input, LSTM, Embedding, Dropout, Activation, CuDNNGRU, Conv1D, Average, Lambda
...
def load_word2vec():
    ...
    #For Word2Vec,we can use word2vec class in genism to load them
...
#get embeddings
embedding_matrix,embedding_name = load_word2vec()
...
clr = CyclicLR(base_lr=0.001, max_lr=0.002,
               ...
               gamma=0.99994)
'''
#mcp_save = ModelCheckpoint('word2vec.hdf5', save_best_only=True, monitor='val_loss', mode='min')
all_predictions = []
...
print(get_threshold(train_meta,train_y))
